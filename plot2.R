plot2 <- function(datasource = "https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip",
                  archivename = "exdata_data_household_power_consumption.zip", filename = "household_power_consumption.txt") {
  
  ## This is the script for downloading the data, tidying it, and creating plot2.png
  ...
  ## The output of this script is the file "plot2.png".
